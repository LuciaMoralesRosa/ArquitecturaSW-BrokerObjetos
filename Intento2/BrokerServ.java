...
public interface BrokerServ extends Remote {
     ...
     */
    void registrarServidor(String nombre_servidor, String host_remoto_IP_puerto)
     ...
     * @throws RemoteException Si ocurre un error durante la comunicación remota.
     */
    void altaServicio(String nombre_servidor, String nom_servicio,
                      Vector<Object> listaParametros, String tipo_retorno)
                      throws RemoteException;
     ...
     * @throws RemoteException Si ocurre un error durante la comunicación remota.
     */
    void bajaServicio(String nombre_servidor, String nom_servicio)
                      throws RemoteException;
